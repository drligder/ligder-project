...
const SECTION_DB = 'LIGDER TECHNICAL';
const SECTION_LABEL = 'Ligder Technical';
const BOARD_BASE = '/forums/ligder-technical';

const LigderTechnicalPage = () => {
...
export default LigderTechnicalPage;
