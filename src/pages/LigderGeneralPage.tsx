...
const SECTION_DB = 'LIGDER GENERAL';
const SECTION_LABEL = 'Ligder General';
const BOARD_BASE = '/forums/ligder-general';

const LigderGeneralPage = () => {
...
export default LigderGeneralPage;
